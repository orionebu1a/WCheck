...
public class RegisterTest {
    ...
    public void registerTest() throws Exception{
        ...
        registrationController.signUp(new SignUpRequest(name, password));
    ...
    public void multiRegisterTest() throws Exception{
        ...
        ResponseEntity<String> responseEntity1 = registrationController.signUp(new SignUpRequest(name1, password1));
        ResponseEntity<String> responseEntity2 = registrationController.signUp(new SignUpRequest(name1, password2));
